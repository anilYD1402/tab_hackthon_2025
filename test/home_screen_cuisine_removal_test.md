# QA Test Case: Remove American and Indian Cuisines from Home Screen Filter

## PR Details
- **PR Link**: https://github.com/anilYD1402/tab_hackthon_2025/pull/new/pr-31
- **Title**: Remove American and Indian cuisines from home screen filter list
- **File Modified**: `lib/screens/home_screen.dart` (lines 16-22)
- **Changes**: Removed 'American' and 'Indian' from the cuisines list in HomeScreen widget
